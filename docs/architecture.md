...
- **Save** always creates the next version for the selected group.
...
class StorageBackend:
    ...
    def load_script(self, group, version) -> ScriptSections: ...
    def load_data(self, group) -> DataFrame | None: ...
    def load_artifact(self, group, version) -> bytes | None: ...
    def save_version(self, group, sections) -> str: ...
